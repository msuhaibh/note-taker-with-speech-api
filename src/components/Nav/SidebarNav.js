...
function SidebarNav(props) {
    ...
    const drawer = (
        <div>
            ...
            <Divider/>
            <List>
                {['Add Note By Text', 'Add Note By Voice', 'Your Notes'].map((text) => (
...
// const SidebarNav = () => {     return (                 <nav
// className="col-md-2 d-none d-md-block bg-dark sidebar px-4">
//    <div className="sidebar-sticky">                         <ul
// className="nav flex-column">                             <li
// className="nav-item">                                 <a className="nav-link
// active" href="#">                                     <span
// data-feather="text"></span>                                     Add Note By
// Text                                     <span
// className="sr-only">(current)</span>                                 </a>
//                         </li>                             <li
// className="nav-item">                                 <a className="nav-link"
// href="#">                                     <span
// data-feather="voice"></span>                                     Add Note By
// Voice                                 </a>                             </li>
//                            <li className="nav-item">
//        <a className="nav-link" href="#">
// <span data-feather="view-notes"></span>
// View Notes                                 </a>
// </li>                         </ul>                     </div>
//  </nav>     ) }
